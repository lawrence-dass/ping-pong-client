            ...
            {getFieldDecorator('name', {
              rules: [
                { required: true, message: 'Please enter your name.' },
                {
                  min: 4,
                  max: 10,
                  message: 'Username must between 4 to 10 characters.'
                }
              ]
            })(
              <Input
...
// antd form wrapper
const WrappedRegisterModal = Form.create({ name: 'normal_register' })(
  RegisterModal
);
...
const connectedRegisterModal = connect(
  null,
  actionCreators
)(WrappedRegisterModal);
